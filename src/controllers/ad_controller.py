...
class AdController:
    ...
    def __call__(self, conversation, **kwargs):
        ...
        url, aff_link, image_url, name, details, call_to_action = most_similar_contents[['url', 'aff_link', 'image_url', 'name', 'properties', 'call_to_action']].iloc[0]

        conversational_ad_content, advertisement_content = self.openai_helper.create_advertising_content(conversation, url, aff_link, name, details, call_to_action, image_url=image_url)
